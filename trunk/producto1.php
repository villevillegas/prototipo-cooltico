				...
				<div class="col-md-12 column">
					<ul class="nav nav-tabs ">
						...
						<li>
                                                ...
                                                <li>
                                                    <a href="productos_electronicos.php">Productos Electronicos</a>
						</li>
<!--						<li class="active">
...
<!--								<li class="divider">
			...
			<!--
			 <a id="modal-85591" href="#modal-container-85596" role="button" class="btn" data-toggle="modal">ejemplo1</a>
                         ...
                         <a id="modal-85594" href="#modal-container-85596" role="button" class="btn" data-toggle="modal">ejemplo4</a>
                         <a id="modal-85595" href="#modal-container-85596" role="button" class="btn" data-toggle="modal">ejemplo5</a>
			
			<div class="modal fade" id="modal-container-85596" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="row clearfix">
		<div class="col-md-4 column">
			<div class="carousel slide" id="carousel-54175">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-54175">
					</li>
					<li data-slide-to="1" data-target="#carousel-54175">
					</li>
					<li data-slide-to="2" data-target="#carousel-54175">
					</li>
				</ol>
				...
				</div> <a class="left carousel-control" href="#carousel-54175" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a> <a class="right carousel-control" href="#carousel-54175" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
			</div>
		</div>
		<div class="col-md-4 column">
			<div class="carousel slide" id="carousel-347893">
				<ol class="carousel-indicators">
					<li data-slide-to="0" data-target="#carousel-347893">
					</li>
					<li data-slide-to="1" data-target="#carousel-347893" class="active">
					</li>
					<li data-slide-to="2" data-target="#carousel-347893">
					</li>
				</ol>
				<div class="carousel-inner">
					<div class="item">
				...
				</div> <a class="left carousel-control" href="#carousel-347893" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a> <a class="right carousel-control" href="#carousel-347893" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
			</div>
		</div>
		<div class="col-md-4 column">
			<div class="carousel slide" id="carousel-329547">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-329547">
					</li>
					<li data-slide-to="1" data-target="#carousel-329547">
					</li>
					<li data-slide-to="2" data-target="#carousel-329547">
					</li>
				</ol>
				<div class="carousel-inner">
					<div class="item active">
				...
				</div> <a class="left carousel-control" href="#carousel-329547" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a> <a class="right carousel-control" href="#carousel-329547" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
			</div>
		</div>
	</div>
	<div class="row clearfix">
